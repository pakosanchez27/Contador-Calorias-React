...
export default function From({ dispatch, state}: FormProps) {
    ...
    return (
        ...
        >
            ...
            <input type="submit" className="bg-gray-800 hover:bg-gray-900 w-full p-2 font-bold uppercase text-white cursor-pointer disabled:opacity-10" value={activity.category === 1 ? 'Guaradar Comida' : 'Guaradar Ejercicio'} disabled={!isValidActivity()} />
        </form>
    )
}
